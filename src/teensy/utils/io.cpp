...
void redirect_reset() { s_log_publisher = nullptr; }
...
void debug(const char *format, ...) { LOG_WITH_LEVEL(LogLevel::DEBUG, format); }

void info(const char *format, ...) { LOG_WITH_LEVEL(LogLevel::INFO, format); }

void warning(const char *format, ...) { LOG_WITH_LEVEL(LogLevel::WARNING, format); }

void error(const char *format, ...) { LOG_WITH_LEVEL(LogLevel::ERROR, format); }
} // namespace utils::io